        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 bg-gradient-to-br from-green-500 via-green-600 to-emerald-600 rounded-lg flex items-center justify-center shadow-lg relative overflow-hidden">
                ...
                <svg width="6" height="6" viewBox="0 0 24 24" fill="none" className="text-yellow-300 absolute -bottom-0.5 -right-0.5">
              ...
              <h3 className="text-lg font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
                WTS<span className="text-orange-500">SHORT</span>
              </h3>
            </div>
