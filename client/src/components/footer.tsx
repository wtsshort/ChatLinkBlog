        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg relative overflow-hidden border border-green-300/20">
                ...
                <div className="relative flex items-center justify-center gap-0.5">
                  ...
                  <div className="w-4 h-4 bg-gradient-to-r from-green-200 to-emerald-200 rounded-md flex items-center justify-center">
                    <svg width="8" height="8" viewBox="0 0 24 24" fill="none" className="text-green-800">
              ...
              <h3 className="text-lg font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
                WTS<span className="bg-gradient-to-r from-green-700 to-emerald-700 bg-clip-text text-transparent font-extrabold">SHORT</span>
              </h3>
            </div>
