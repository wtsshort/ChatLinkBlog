          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg relative overflow-hidden border border-green-300/20">
                ...
                {/* Modern WhatsApp Brand Logo */}
                <div className="relative flex items-center justify-center">
                  {/* Main WhatsApp icon with enhanced styling */}
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-white relative z-10 drop-shadow-md">
                  ...
                  <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center border border-white/30">
