                ...
                <div className="flex items-center gap-3 cursor-pointer group" data-testid="logo">
                  <div className="relative">
                    ...
                    <div className="w-11 h-11 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-105 relative overflow-hidden border border-green-300/20">
                      ...
                      {/* Logo design with WhatsApp and Link side by side */}
                      <div className="relative flex items-center justify-center gap-1">
                        {/* WhatsApp icon */}
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-white relative z-10 drop-shadow-sm">
                        ...
                        {/* Link icon - larger and side by side */}
                        <div className="w-5 h-5 bg-gradient-to-r from-green-300 to-emerald-300 rounded-lg flex items-center justify-center shadow-sm">
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" className="text-green-800">
                  ...
                  <div className="flex flex-col">
                    <h1 className="text-xl font-black bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent group-hover:from-green-500 group-hover:via-emerald-500 group-hover:to-green-600 transition-all duration-500 tracking-tight">
                      WTS<span className="bg-gradient-to-r from-green-700 via-emerald-700 to-green-800 bg-clip-text text-transparent group-hover:from-green-600 group-hover:via-emerald-600 group-hover:to-green-700 transition-all duration-300 font-extrabold">SHORT</span>
                    </h1>
                  ...
                  <div className="hidden sm:flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-500">
                    ...
                    <span className="text-xs text-muted-foreground font-medium bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">
